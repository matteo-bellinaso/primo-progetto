...
import { AtoForPipe } from './ato-for.pipe';
// devo importare tutti i componenti

@NgModule({
  declarations: [
    AppComponent, // in questa zona va dichiarato ogni tipo di componente che viene aggiunto
    ListComponent, DetailComponent, AfterViewComponent, NavbarComponent, HomeComponent, HighlightDirective, AtoForPipe // nel nostro caso la lista1
  ],
